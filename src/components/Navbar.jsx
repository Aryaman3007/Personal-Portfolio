    ...
    return(
        <>
            ...
            <div className={`flex justify-center items-center rounded-full p-[4px] cursor-pointer ${props.darkmode?'bg-[#181818]':'bg-[#ecf3ff]'}`}>
              <p onClick={() => {window.open('https://drive.google.com/file/d/148RJqCVlr34k2lMKjOpCA11imzZtRKkU/view?usp=sharing', "_blank");}} className={`rounded-full px-[10px] py-[4px] text-center ${props.darkmode?'hover:bg-[#232323]':'hover:bg-[#fefffe]'}`}>Resume</p>
            </div>
        </>
    );
}